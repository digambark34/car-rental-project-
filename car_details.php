...
if(isset($_POST['submit']))
{
  ...
  if($query1->rowCount()==0)
  {
    ...
    if($lastInsertId)
    {
             ...
             echo "<script type='text/javascript'> document.location = 'https://rzp.io/l/G5CC1oH'; </script>";
      ...
      <section id="clients"  class="wow fadeInUp">
        <div class="container">
          <div class="section-header">
            <h2>Car details</h2>
            <p>This are the cars that are available on our website,you can choose a car according to your need..!  </p>
          </div>
          <?php 
          ...
          <aside class="col-md-3">
            ...
            <div class="share_vehicle">
              <p>Share: <a href="https://www.facebook.com/digambar.kothawale.58"><i class="fa fa-facebook-square" aria-hidden="true"></i></a> <a href="https://twitter.com/Sarth26842251?t=7Kmk8bePb_nyzeJameFjcQ&s=08"><i class="fa fa-twitter-square" aria-hidden="true"></i></a> <a href="https://in.linkedin.com/in/digambar-kothawale-a3aa2a219"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a> <a href="https://www.google.co.in/"><i class="fa fa-google-plus-square" aria-hidden="true"></i></a> </p>
            </div>
            <div class="sidebar_widget">
              ...
              <form method="post">
                ...
                {?>
                  <div class="form-group">
                    <input type="submit" class="btn" href ="https://rzp.io/l/cEZ6vMn9jN"style="background-color: #49a3ff;"  name="submit" value="Book Now">
                  </div>
                  <?php 
                } else { ?>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-9 text-center text-lg-left">
              ...
              <p class="cta-text">Our Service Provides good & excellent condition vehicles for rent in Affordable Price which anyone can get advantage of driving various types of vehicles.</p>
            </div>
