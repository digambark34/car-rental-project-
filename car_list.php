...
<body id="body"> 
 ...
 <section id="innerBanner"> 
  <div class="inner-content">
    <h2><span>Car Listing</span><br>Enjoy your holidays with our wheels!</h2>
    <div> 
    </div>
  </div> 
</section><!-- #Page Banner -->
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-9 text-center text-lg-left">
              ...
              <p class="cta-text">Our Service Provides good & excellent condition vehicles for rent in Affordable Price which anyone can get advantage of driving various types of vehicles.
              </p>
            </div>
